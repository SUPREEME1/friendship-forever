const config = {
    ...
    questions: [
        ...
        },
        {
            ...
            options: ["Books – I love getting lost in a story", 
                     "Movies – They bring stories to life visually",
                     "Podcasts – I enjoy listening and learning",
                     "All of them, depending on my mood"],
            answer: 0
        },
        {
            question: "If she could travel anywhere in the world right now, where would you go?",
            options: ["Paris – for romance and fashion", 
                     "Maldives – for beaches and relaxation",
                     "Japan – for the culture and food",
                     "South Africa – to explore my own country more"],
            answer: 1
        },
        {
        ...
        },
        {
            ...
            options: ["Morning person – I love starting my day early",
                     "Night owl – I'm most productive at night",
                     "Depends on the day",
        ...
        {
            question: "What’s her ideal way to spend a rainy day?",
        ...
        },
        {
            ...
            options: ["Beyoncé", "Elon Musk", "Zendaya", "Rihanna"],
            answer: 2
        },
        {
            question: "What’s her favorite childhood memory?",
        ...
        {
            question: "What’s something she always carries with her?",
        ...
        {
            question: "What’s her dream way to celebrate a special occasion?",
        ...
        {
            question: "What’s her go-to drink order?",
            options: ["Coffee", "Tea", "Smoothie", "Iced Latte"],
            answer: 3
        },
        {
            question: "What’s the one thing that instantly makes her happy?",
        ...
        {
            question: "What’s the one thing she always says?",
            options: ["'I got this!'", "'That’s crazy!'", "'Let’s do it!'", "'I need coffee first'"],
            answer: 1
        },
        {
        ...
        {
            question: "What’s her hidden talent?",
            options: ["Singing", "Drawing", "Dancing", "Remembering random facts"],
            answer: 3
        },
        {
            question: "If she had to survive in the wild for a week, what’s the one thing she’d bring?",
...
function saveMessage() {
    ...
    if (message) {
        ...
        input.value = '';
        alert('💖 Message saved to our memory vault!');
    } else {
...
function generatePDF() {
    ...
    doc.setFontSize(24);
    doc.setTextColor(255, 105, 180);
    doc.text("Friendship Forever 💖", 60, 140);
